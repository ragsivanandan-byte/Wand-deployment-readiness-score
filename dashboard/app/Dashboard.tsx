  ...
  return (
    <div className="mb-6 flex flex-wrap gap-3 items-center text-sm">
      ...
      <details className="ml-auto w-full md:w-auto">
        <summary className="cursor-pointer text-accent hover:text-ink list-none">
          Thresholds {dirty && <span className="text-amber-400">· modified</span>}
        </summary>
        <div className="mt-3 p-4 bg-panel border border-line rounded-lg w-full md:w-[420px] space-y-2">
...
function Footer({ data }: { data: RunPayload }) {
  ...
  return (
    <footer className="mt-16 pt-6 border-t border-line text-muted text-xs leading-relaxed space-y-2">
      <div>
      ...
      <div>
        <a href={`${basePath}/run.json`} className="text-accent hover:text-ink underline">
          Download raw run.json
        </a>
        {" · "}
        <a href="https://github.com/ragsivanandan-byte/Wand-deployment-readiness-score"
